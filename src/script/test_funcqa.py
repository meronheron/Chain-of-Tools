...
def multiple_run(config, logger):
    ...
    model.sl_judge("./output/funcqa_judge_checkpoint_dir/epoch_1/", "load")
    checkpoint_list = ["./output/funcqa_retriever_checkpoint_dir/epoch_{}/".format(epoch) for epoch in range(3,11)]
